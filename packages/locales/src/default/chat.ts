export default {
  ...
  'goalProcess.metricDetail.budget.rounds': 'Round cap',
  'goalProcess.metricDetail.budget.spendNote':
    'Per-run spend is recorded on each dispatched task \u2014 open a task to see what its runs actually cost.',
  'goalProcess.metricDetail.budget.title': 'Budget',
  'goalProcess.metricDetail.budget.totalCost': 'Total cost cap',
  ...
  'goalProcess.metrics.budget': 'Budget',
  ...
  'workingPanel.overview.branch': 'Branch',
  'workingPanel.overview.branch.detached': 'Detached HEAD',
  'workingPanel.overview.changes': 'Changes',
  'workingPanel.overview.changes.clean': 'No working tree changes',
  'workingPanel.overview.changes.files_one': '{{count}} file modified',
  'workingPanel.overview.changes.files_other': '{{count}} files modified',
  ...
  'workingPanel.overview.environment': 'Environment',
  ...
  'workingPanel.overview.documents.desc': 'Documents available to this agent',
  'workingPanel.overview.execution.local': 'This device',
  'workingPanel.overview.outputs': 'Outputs',
  'workingPanel.overview.resources': 'Resources',
  'workingPanel.overview.skills.desc': 'Skills available to this agent',
